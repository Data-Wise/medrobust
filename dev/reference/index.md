...
- [`plot_bootstrap_distribution()`](https://data-wise.github.io/medrobust/dev/reference/plot_bootstrap_distribution.md)
...
- [`power_analysis_result`](https://data-wise.github.io/medrobust/dev/reference/power_analysis_result.md)
...
- [`extract_falsified_region()`](https://data-wise.github.io/medrobust/dev/reference/extract_falsified_region.md)
  : Extract Falsified Region
- [`new_falsification_summary()`](https://data-wise.github.io/medrobust/dev/reference/new_falsification_summary.md)
  : Create Falsification Summary Object
- [`test_multiple_hypotheses()`](https://data-wise.github.io/medrobust/dev/reference/test_multiple_hypotheses.md)
...
- [`compute_bound_se()`](https://data-wise.github.io/medrobust/dev/reference/compute_bound_se.md)
...
- [`as.data.frame(`*`<medrobust_bounds>`*`)`](https://data-wise.github.io/medrobust/dev/reference/as.data.frame.medrobust_bounds.md)
  : Coerce to data frame (S3 - Legacy)
- [`as.list(`*`<sensitivity_region>`*`)`](https://data-wise.github.io/medrobust/dev/reference/as.list.sensitivity_region.md)
  : Convert sensitivity_region S7 object to list
- [`print(`*`<compatibility_test>`*`)`](https://data-wise.github.io/medrobust/dev/reference/print.compatibility_test.md)
  : Print Method for compatibility_test
- [`summary(`*`<compatibility_test>`*`)`](https://data-wise.github.io/medrobust/dev/reference/summary.compatibility_test.md)
  : Summary Method for compatibility_test
- [`format_effect()`](https://data-wise.github.io/medrobust/dev/reference/format_effect.md)
...
- [`heals_data`](https://data-wise.github.io/medrobust/dev/reference/heals_data.md)
  : Synthetic HEALS Data with Differential Measurement Error
- [`simulated_dm_data`](https://data-wise.github.io/medrobust/dev/reference/simulated_dm_data.md)
