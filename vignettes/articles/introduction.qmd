...
If you already have a `medrobust_bounds` object and want to add or update confidence
intervals without re-running the full grid search, use `bound_ci()` directly:
